<%-- 
    Document   : login
    Created on : Jul 20, 2023, 9:33:46 PM
    Author     : Narasimha
--%>
    ...
    <head>
        ...
        <style>
            ...
            body {
               ...
               background-image:url(https://theinfoz.com/wp-content/uploads/2019/10/job-portal-development.jpg);
    ...
    <input type="hidden" name="handleMessage" id="handleMessage" value="<%=message%>">
        <div class="container">
            ...
            <p class="text-center mt-3">Don't have an account? 
                <br><a href="register_student.jsp">Register here</a>.</p><br>
                <!--<br><a href="register_admin.jsp">Register here</a>.</p><br>-->
                <br><a href="register_recruiter.jsp">Register here</a>.</p><br>
        </div>
</html>
